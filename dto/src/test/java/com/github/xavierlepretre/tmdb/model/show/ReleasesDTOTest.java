...
public class ReleasesDTOTest
{
    ...
    {
        ReleasesDTO dto = mapper.readValue(getClass().getResourceAsStream("releases_dto_1.json"), ReleasesDTO.class);
    ...
    public void cannotDeserialiseMissingCountries() throws Exception
    {
        ...
        mapper.readValue(getClass().getResourceAsStream("releases_dto_1_missing_countries.json"), ReleasesDTO.class);
    }
}
